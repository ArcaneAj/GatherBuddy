...
namespace GatherBuddy.Sync.Services
{
    public interface ITableService
    {
        ...
        IEnumerable<Response<IReadOnlyList<Response>>> UpsertBatch<T>(string tableName, IEnumerable<T> entities) where T : ITableEntity;
        ...
        IEnumerable<Response<IReadOnlyList<Response>>> DeleteBatch<T>(string tableName, IEnumerable<T> entities) where T : ITableEntity;
        ...
        Task<IEnumerable<Response<IReadOnlyList<Response>>>> UpsertBatchAsync<T>(string tableName, IEnumerable<T> entities) where T : ITableEntity;
        ...
        Task<IEnumerable<Response<IReadOnlyList<Response>>>> DeleteBatchAsync<T>(string tableName, IEnumerable<T> entities) where T : ITableEntity;
